...
Inimigos_Fase_2::Inimigos_Fase_2()
{
    ...
    /**Inicializando posi��o de Slimes**/
    //Parte 1
    for (int i = 0; i < 5; i++)
    {
    ...
    /**Inicializando posi��o de Goblins**/
    //Parte 1
    for (int i = 0; i < 5; i++)
    {
    ...
    /**Inicializando posi��o de Morcegos**/
    //Parte 1
    for (int i = 0; i < 2; i++)
    {
    ...
    /**Inicializando posi��o de Slime Lava**/
    //Parte 2
    for (int i = 0; i < 3; i++)
    {
    ...
    /**Inicializando posi��o de Esqueleto**/
    //Parte 3
    for (int i = 0; i < 3; i++)
    {
    ...
    /**Inicializando posi��o de Fogo Fatuo**/
    //Parte 2
    for (int i = 0; i < 4; i++)
    {
