...
void Jogador::atualiza()
{
    ...
    if (funcionando)
    {
        for (int i = 0; i < NUM_TECLAS_JOGADOR; i ++)
            ...
            if (colisao[COLIDE_Y])/**Para o jogador em y se ele estiver colidindo com o ch�o ou uma plataforma**/
            {
...
{
    /**REFERENTES A MOVIMENTA��O HORIZONTAL**/
...
{
    /**Para o jogador em x se ele estiver colidindo com o ch�o pela lateral**/
